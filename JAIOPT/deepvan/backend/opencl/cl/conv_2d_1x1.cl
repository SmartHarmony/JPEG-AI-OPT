...
__kernel void conv_2d_1x1(OUT_OF_RANGE_PARAMS
...
#ifdef ELEMENT
  out0 += READ_IMAGET(elt, SAMPLER, (int2)(out_x_base + out_x_idx, out_hb));
#endif
...
#ifdef ELEMENT
  out1 += READ_IMAGET(elt, SAMPLER, (int2)(out_x_base + out_x_idx, out_hb));
#endif
  ...
  if (out_x_idx >= width) return;
#ifdef ELEMENT
  out2 += READ_IMAGET(elt, SAMPLER, (int2)(out_x_base + out_x_idx, out_hb));
#endif
  ...
  if (out_x_idx >= width) return;
#ifdef ELEMENT
  out3 += READ_IMAGET(elt, SAMPLER, (int2)(out_x_base + out_x_idx, out_hb));
#endif
