...
// Only keep this first matmul, delete others,matmul_buffer.cl, matmulf.cl
__kernel void matmul(OUT_OF_RANGE_PARAMS GLOBAL_WORK_GROUP_SIZE_DIM2 __read_only
                         image2d_t A,
  ...
  if (gx >= (global_size_dim0 * 4) || hb >= global_size_dim1)
    return;
#endif
