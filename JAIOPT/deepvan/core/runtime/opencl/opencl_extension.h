#ifndef DEEPVAN_CORE_RUNTIME_OPENCL_OPENCL_EXTENSION_H_
#define DEEPVAN_CORE_RUNTIME_OPENCL_OPENCL_EXTENSION_H_
...
#endif  // DEEPVAN_CORE_RUNTIME_OPENCL_OPENCL_EXTENSION_H_
